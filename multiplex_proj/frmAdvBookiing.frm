...
Begin VB.Form frmAdvBookiing 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox cmbTheaterNo 
         BackColor       =   &H00C0FFFF&
         Height          =   315
         ItemData        =   "frmAdvBookiing.frx":0000
         Left            =   1560
         List            =   "frmAdvBookiing.frx":000D
      ...
      Begin VB.ComboBox cmbClass 
         BackColor       =   &H00C0FFFF&
         Height          =   315
         ItemData        =   "frmAdvBookiing.frx":001A
         Left            =   1560
         List            =   "frmAdvBookiing.frx":0027
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   720
         Width           =   1695
   ...
   Begin VB.Image Image2 
      Height          =   495
      Left            =   4320
      Picture         =   "frmAdvBookiing.frx":0046
      Top             =   1920
      Width           =   3750
   End
End
