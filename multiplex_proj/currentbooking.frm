...
Begin VB.Form frmcurrentbooking 
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   495
      Left            =   2760
      MouseIcon       =   "currentbooking.frx":0000
   ...
   Begin VB.CommandButton cmdclose 
      ...
      Height          =   375
      Left            =   12360
      MouseIcon       =   "currentbooking.frx":030A
      MousePointer    =   99  'Custom
      Style           =   1  'Graphical
      TabIndex        =   31
      Top             =   3360
   ...
   Begin VB.CommandButton cmdsave 
      ...
      Height          =   375
      Left            =   10560
      MouseIcon       =   "currentbooking.frx":0614
      MousePointer    =   99  'Custom
      Style           =   1  'Graphical
      TabIndex        =   30
      Top             =   3360
   ...
   Begin VB.ComboBox cmbShow 
      Height          =   315
      ItemData        =   "currentbooking.frx":091E
      Left            =   3480
      List            =   "currentbooking.frx":0920
   ...
   Begin VB.ComboBox cmbClass 
      Height          =   315
      ItemData        =   "currentbooking.frx":0922
      Left            =   3480
      List            =   "currentbooking.frx":092F
      Style           =   2  'Dropdown List
      TabIndex        =   9
      Top             =   1800
      Width           =   1935
   ...
   Begin VB.ComboBox cmbScreen 
      Height          =   315
      ItemData        =   "currentbooking.frx":094B
      Left            =   3480
      List            =   "currentbooking.frx":0961
      Style           =   2  'Dropdown List
      TabIndex        =   7
      Top             =   1080
      Width           =   1935
   ...
   Begin VB.Image Image1 
      Height          =   315
      Left            =   960
      Picture         =   "currentbooking.frx":0977
      Top             =   4320
      Width           =   13485
   End
   ...
   Begin VB.Image Image2 
      Height          =   315
      Left            =   960
      Picture         =   "currentbooking.frx":1299
      Top             =   5760
      Width           =   13530
   End
   Begin VB.Image Image3 
      Height          =   315
      Left            =   960
      Picture         =   "currentbooking.frx":2048
      Top             =   8160
      Width           =   13470
   End
   ...
   Begin VB.Image Image4 
      Height          =   990
      Left            =   2640
      Picture         =   "currentbooking.frx":2E27
      Top             =   9480
      Width           =   10275
   End
End
    ...
    With rs1
        ...
        While .EOF <> True
            If rs1(1) = cmbScreen.ListIndex + 1 Then
                If Format(rs1(2), "dd/MMM/yyyy") = Format(Date, "dd/MMM/yyyy") Then
...
On Error Resume Next
    ...
    cn1.Execute "insert into booking values ('" & a & "'," & b & ",'" & c & "','" & d & "','C'," & Val(f) & "," & Val(g) & "," & Val(h) & "," & Val(i) & ")"
    rs1.Close
    cn1.Close
    ...
    z = Format(Now, "dd/MMM/yyyy")
       
    With rs5
    .MoveFirst
    
    While .EOF <> True
        If Format(rs5(0), "dd/MMM/yyyy") = Format(Now, "dd/MMM/yyyy") Then
   ...
   cn5.Execute "insert into collection values ('" & Format(Now, "dd/MMM/yyyy") & "',0,0,0,0,0,0,0)"
